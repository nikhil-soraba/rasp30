...
dac_loc(2,4).entries(1)= '0 9 0 #int[0]'; dac_loc(2,4).entries(2)= '3'; //DAC3
dac_loc(2,5).entries(1)= '0 9 1 #int[1]'; dac_loc(2,5).entries(2)= '4'; //DAC4
dac_loc(2,6).entries(1)= '0 9 2 #int[2]'; dac_loc(2,6).entries(2)= '5'; //DAC5
dac_loc(2,7).entries(1)= '0 9 3 #int[3]'; dac_loc(2,7).entries(2)= '6'; //DAC6
dac_loc(2,8).entries(1)= '0 9 4 #int[4]'; dac_loc(2,8).entries(2)= '7'; //DAC7
dac_loc(2,9).entries(1)= '0 9 5 #int[5]'; dac_loc(2,9).entries(2)= '8'; //DAC8
dac_loc(2,10).entries(1)= '0 10 0 #int[0]'; dac_loc(2,10).entries(2)= '9'; //DAC9
dac_loc(2,11).entries(1)= '0 10 1 #int[1]'; dac_loc(2,10).entries(2)= '10'; //DAC10
dac_loc(2,11).entries(1)= '0 10 2 #int[2]'; dac_loc(2,11).entries(2)= '11'; //DAC11
...
//********** 3.0a **********
adc_locin(2,1).entries='0 5 3 #int[3]'; //adc in 0
adc_locin(2,2).entries='0 5 4 #int[4]'; //adc in 1
...
iopad_loc(2,72).entries='8 12 4 #int[4]'; //Vg  _array_gate sel
iopad_loc(2,73).entries='0 11 2 #int[2]'; //Vg  _array_gate sel
