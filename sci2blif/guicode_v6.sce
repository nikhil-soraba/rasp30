...
file31_menu = uimenu("Parent", file_menu, "Label", gettext("Simulations"));
...
file30_menu = uimenu("Parent", file23_menu, "Label", gettext("HH Neuron"), "callback", "file30_callback()");//  w/pad
...
function file31_callback()
    global file_name path fname extension

    unix_s('cp /home/ubuntu/rasp30/work/examples/SIM/nmos_ekv_sim.xcos /home/ubuntu/RASP_Workspace/demo_files/SIM/');
    file_name= '/home/ubuntu/RASP_Workspace/demo_files/SIM/nmos_ekv_sim.xcos';
    [path,fname,extension]=fileparts(file_name);
...
function file32_callback()
    global file_name path fname extension

    unix_s('cp /home/ubuntu/rasp30/work/examples/SIM/pmos_ekv_sim.xcos /home/ubuntu/RASP_Workspace/demo_files/SIM/');
    file_name= '/home/ubuntu/RASP_Workspace/demo_files/SIM/pmos_ekv_sim.xcos';
    [path,fname,extension]=fileparts(file_name);
