global file_name path fname extension chip_num board_num brdtype Macroblif_name folder_name;
...
function Generate_MB_callback()
    global Macroblif_name file_name path fname extension board_num chip_num;
    ...
    while ele_index(1) ~= ".end",
        ...
        if ele_index(1) == "#OTA" then // <---
            ...
            if string_ota(No_ota,4) ~= "vcc" & string_ota(No_ota,4) ~= "gnd" then string_ota(No_ota,4)=string_ota(No_ota,4)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            if string_ota(No_ota,4) == "vcc" | string_ota(No_ota,4) == "gnd" then string_ota(No_ota,4)=string_ota(No_ota,4)+""""; end
            if string_ota(No_ota,6) ~= "vcc" & string_ota(No_ota,6) ~= "gnd" then string_ota(No_ota,6)=string_ota(No_ota,6)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            if string_ota(No_ota,6) == "vcc" | string_ota(No_ota,6) == "gnd" then string_ota(No_ota,6)=string_ota(No_ota,6)+""""; end
            if string_ota(No_ota,8) ~= "vcc" & string_ota(No_ota,8) ~= "gnd" then string_ota(No_ota,8)=string_ota(No_ota,8)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
        ...
        if ele_index(1) == "#FGOTA" then // <---
            ...
            if string_fgota(No_fgota,4) ~= "vcc" & string_fgota(No_fgota,4) ~= "gnd" then string_fgota(No_fgota,4)=string_fgota(No_fgota,4)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            if string_fgota(No_fgota,4) == "vcc" | string_fgota(No_fgota,4) == "gnd" then string_fgota(No_fgota,4)=string_fgota(No_fgota,4)+""""; end
            if string_fgota(No_fgota,6) ~= "vcc" & string_fgota(No_fgota,6) ~= "gnd" then string_fgota(No_fgota,6)=string_fgota(No_fgota,6)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            if string_fgota(No_fgota,6) == "vcc" | string_fgota(No_fgota,6) == "gnd" then string_fgota(No_fgota,6)=string_fgota(No_fgota,6)+""""; end
            if string_fgota(No_fgota,8) ~= "vcc" & string_fgota(No_fgota,8) ~= "gnd" then string_fgota(No_fgota,8)=string_fgota(No_fgota,8)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
        ...
        if ele_index(1) == "#NFET" then // <---
            ...
            if string_nfet(No_nfet,4) ~= "vcc" & string_nfet(No_nfet,4) ~= "gnd" then string_nfet(No_nfet,4)=string_nfet(No_nfet,4)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            if string_nfet(No_nfet,4) == "vcc" | string_nfet(No_nfet,4) == "gnd" then string_nfet(No_nfet,4)=string_nfet(No_nfet,4)+""""; end
            if string_nfet(No_nfet,6) ~= "vcc" & string_nfet(No_nfet,6) ~= "gnd" then string_nfet(No_nfet,6)=string_nfet(No_nfet,6)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            if string_nfet(No_nfet,6) == "vcc" | string_nfet(No_nfet,6) == "gnd" then string_nfet(No_nfet,6)=string_nfet(No_nfet,6)+""""; end
            if string_nfet(No_nfet,8) ~= "vcc" & string_nfet(No_nfet,8) ~= "gnd" then string_nfet(No_nfet,8)=string_nfet(No_nfet,8)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
        ...
        if ele_index(1) == "#PFET" then // <---
            ...
            if string_pfet(No_pfet,4) ~= "vcc" & string_pfet(No_pfet,4) ~= "gnd" then string_pfet(No_pfet,4)=string_pfet(No_pfet,4)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            if string_pfet(No_pfet,4) == "vcc" | string_pfet(No_pfet,4) == "gnd" then string_pfet(No_pfet,4)=string_pfet(No_pfet,4)+""""; end
            if string_pfet(No_pfet,6) ~= "vcc" & string_pfet(No_pfet,6) ~= "gnd" then string_pfet(No_pfet,6)=string_pfet(No_pfet,6)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            if string_pfet(No_pfet,6) == "vcc" | string_pfet(No_pfet,6) == "gnd" then string_pfet(No_pfet,6)=string_pfet(No_pfet,6)+""""; end
            if string_pfet(No_pfet,8) ~= "vcc" & string_pfet(No_pfet,8) ~= "gnd" then string_pfet(No_pfet,8)=string_pfet(No_pfet,8)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
        ...
        if ele_index(1) == "#TGATE" then // <---
            ...
            if string_tgate(No_tgate,4) ~= "vcc" & string_tgate(No_tgate,4) ~= "gnd" then string_tgate(No_tgate,4)=string_tgate(No_tgate,4)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            if string_tgate(No_tgate,4) == "vcc" | string_tgate(No_tgate,4) == "gnd" then string_tgate(No_tgate,4)=string_tgate(No_tgate,4)+""""; end
            if string_tgate(No_tgate,6) ~= "vcc" & string_tgate(No_tgate,6) ~= "gnd" then string_tgate(No_tgate,6)=string_tgate(No_tgate,6)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            if string_tgate(No_tgate,6) == "vcc" | string_tgate(No_tgate,6) == "gnd" then string_tgate(No_tgate,6)=string_tgate(No_tgate,6)+""""; end
            if string_tgate(No_tgate,8) ~= "vcc" & string_tgate(No_tgate,8) ~= "gnd" then string_tgate(No_tgate,8)=string_tgate(No_tgate,8)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
        ...
        if ele_index(1) == "#NMIRROR" then // <---
            ...
            if string_nmirror(No_nmirror,4) ~= "vcc" & string_nmirror(No_nmirror,4) ~= "gnd" then string_nmirror(No_nmirror,4)=string_nmirror(No_nmirror,4)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            ...
            if string_nmirror(No_nmirror,6) ~= "vcc" & string_nmirror(No_nmirror,6) ~= "gnd" then string_nmirror(No_nmirror,6)=string_nmirror(No_nmirror,6)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
        ...
        if ele_index(1) == "#CAP" then // <---
            ...
            if string_cap(No_cap,4) ~= "vcc" & string_cap(No_cap,4) ~= "gnd" then string_cap(No_cap,4)=string_cap(No_cap,4)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            if string_cap(No_cap,4) == "vcc" | string_cap(No_cap,4) == "gnd" then string_cap(No_cap,4)=string_cap(No_vdd_out,4)+""""; end
            if string_cap(No_cap,6) ~= "vcc" & string_cap(No_cap,6) ~= "gnd" then string_cap(No_cap,6)=string_cap(No_cap,6)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
        ...
        if ele_index(1) == "#VDD_OUT" then // <---
            ...
            if string_vdd_out(No_vdd_out,4) ~= "vcc" & string_vdd_out(No_vdd_out,4) ~= "gnd" then string_vdd_out(No_vdd_out,4)=string_vdd_out(No_vdd_out,4)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            ...
            if string_vdd_out(No_vdd_out,6) ~= "vcc" & string_vdd_out(No_vdd_out,6) ~= "gnd" then string_vdd_out(No_vdd_out,6)=string_vdd_out(No_vdd_out,6)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            ...
            if string_vdd_out(No_vdd_out,8) ~= "vcc" & string_vdd_out(No_vdd_out,8) ~= "gnd" then string_vdd_out(No_vdd_out,8)=string_vdd_out(No_vdd_out,8)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
        ...
        if ele_index(1) == "#GND_OUT" then // <---
            ...
            if string_gnd_out(No_gnd_out,4) ~= "vcc" & string_gnd_out(No_gnd_out,4) ~= "gnd" then string_gnd_out(No_gnd_out,4)=string_gnd_out(No_gnd_out,4)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            ...
            if string_gnd_out(No_gnd_out,6) ~= "vcc" & string_gnd_out(No_gnd_out,6) ~= "gnd" then string_gnd_out(No_gnd_out,6)=string_gnd_out(No_gnd_out,6)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            ...
            if string_gnd_out(No_gnd_out,8) ~= "vcc" & string_gnd_out(No_gnd_out,8) ~= "gnd" then string_gnd_out(No_gnd_out,8)=string_gnd_out(No_gnd_out,8)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
        ...
        if ele_index(1) == "#VDD_DIG" then // <---
            ...
            if string_vdd_dig(No_vdd_dig,4) ~= "vcc" & string_vdd_dig(No_vdd_dig,4) ~= "gnd" then string_vdd_dig(No_vdd_dig,4)=string_vdd_dig(No_vdd_dig,4)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            ...
            if string_vdd_dig(No_vdd_dig,6) ~= "vcc" & string_vdd_dig(No_vdd_dig,6) ~= "gnd" then string_vdd_dig(No_vdd_dig,6)=string_vdd_dig(No_vdd_dig,6)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            ...
            if string_vdd_dig(No_vdd_dig,8) ~= "vcc" & string_vdd_dig(No_vdd_dig,8) ~= "gnd" then string_vdd_dig(No_vdd_dig,8)=string_vdd_dig(No_vdd_dig,8)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
        ...
        if ele_index(1) == "#GND_DIG" then // <---
            ...
            if string_gnd_dig(No_gnd_dig,4) ~= "vcc" & string_gnd_dig(No_gnd_dig,4) ~= "gnd" then string_gnd_dig(No_gnd_dig,4)=string_gnd_dig(No_gnd_dig,4)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            ...
            if string_gnd_dig(No_gnd_dig,6) ~= "vcc" & string_gnd_dig(No_gnd_dig,6) ~= "gnd" then string_gnd_dig(No_gnd_dig,6)=string_gnd_dig(No_gnd_dig,6)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
            ...
            if string_gnd_dig(No_gnd_dig,8) ~= "vcc" & string_gnd_dig(No_gnd_dig,8) ~= "gnd" then string_gnd_dig(No_gnd_dig,8)=string_gnd_dig(No_gnd_dig,8)+"_"+Macroblif_name+"_"""+"+string(bl)"; end
    ...
    mputl("function [x,y,typ]="+Macroblif_name+"(job,arg1,arg2)",fd_w);
    mputl("    x=[];y=[];typ=[];",fd_w);
    ...
    mputl("        model.sim=list(''"+Macroblif_name+"_c'',5)",fd_w);
    ...
    mputl("        gr_i=[''txt=[''''"+Macroblif_name+"''''];'';''xstringb(orig(1),orig(2),txt,sz(1),sz(2),''''fill'''');'']",fd_w);
    ...
    mputl("style.displayedLabel="""+Macroblif_name+"""",fd_w);
    mputl("pal5=xcosPalAddBlock(pal5,"""+Macroblif_name+""",[],style);",fd_w);
    mclose(fd_w);
    ...
    mputl("//**************************** "+Macroblif_name+" **********************************",fd_w);
    mputl("if (blk_name.entries(bl) == """+Macroblif_name+""") then",fd_w);
    mputl("    mputl(""#"+Macroblif_name+""",fd_w);",fd_w);
    mputl("    for ss=1:scs_m.objs(bl).model.ipar(1)",fd_w);
    if No_ota ~= 0 then //<---
        for i=1:No_ota
            No_of_para_sci2blif=No_of_para_sci2blif+1;
            mputl("        l1_str= """+strcat(string_ota(i,1:3),' ')+"="+string_ota(i,4)+"+"" "+string_ota(i,5)+"="+string_ota(i,6)+"+"" "+string_ota(i,7)+"="+string_ota(i,8)+"+"" "+string_ota(i,9)+" =""+string(sprintf(''%e'',scs_m.objs(bl).model.rpar(scs_m.objs(bl).model.ipar(1)*("+string(No_of_para_sci2blif)+"-1)+ss)));",fd_w);
    ...
    if No_fgota ~= 0 then //<---
        for i=1:No_fgota
            ...
            mputl("        l1_str= """+strcat(string_fgota(i,1:3),' ')+"="+string_fgota(i,4)+"+"" "+string_fgota(i,5)+"="+string_fgota(i,6)+"+"" "+string_fgota(i,7)+"="+string_fgota(i,8)+"+"" "+string_fgota(i,9)+" =""+string(sprintf(''%e'',scs_m.objs(bl).model.rpar(scs_m.objs(bl).model.ipar(1)*("+string(No_of_para_sci2blif-2)+"-1)+ss)))"+"+""&"+string_fgota(i,12)+" =""+string(sprintf(''%e'',scs_m.objs(bl).model.rpar(scs_m.objs(bl).model.ipar(1)*("+string(No_of_para_sci2blif-1)+"-1)+ss)))" +"+""&"+string_fgota(i,15)+" =""+string(sprintf(''%e'',scs_m.objs(bl).model.rpar(scs_m.objs(bl).model.ipar(1)*("+string(No_of_para_sci2blif)+"-1)+ss)));",fd_w);
            mputl("        mputl(l1_str,fd_w);",fd_w);
            mputl("        mputl(""  "",fd_w);",fd_w);
        end
    end
    ...
    if No_cap ~= 0 then //<---
        for i=1:No_cap
            No_of_para_sci2blif=No_of_para_sci2blif+1;
            mputl("        if scs_m.objs(bl).model.rpar(scs_m.objs(bl).model.ipar(1)*("+string(No_of_para_sci2blif)+"-1)+ss) == 1 then cap_size_string=""#cap_1x =0""; end",fd_w);
            mputl("        if scs_m.objs(bl).model.rpar(scs_m.objs(bl).model.ipar(1)*("+string(No_of_para_sci2blif)+"-1)+ss) == 2 then cap_size_string=""#cap_2x =0""; end",fd_w);
            mputl("        if scs_m.objs(bl).model.rpar(scs_m.objs(bl).model.ipar(1)*("+string(No_of_para_sci2blif)+"-1)+ss) == 3 then cap_size_string=""#cap_3x =0""; end",fd_w);
            mputl("        if scs_m.objs(bl).model.rpar(scs_m.objs(bl).model.ipar(1)*("+string(No_of_para_sci2blif)+"-1)+ss) == 4 then cap_size_string=""#cap_3x =0&cap_1x =0""; end",fd_w);
            mputl("        if scs_m.objs(bl).model.rpar(scs_m.objs(bl).model.ipar(1)*("+string(No_of_para_sci2blif)+"-1)+ss) == 5 then cap_size_string=""#cap_3x =0&cap_2x =0""; end",fd_w);
            mputl("        if scs_m.objs(bl).model.rpar(scs_m.objs(bl).model.ipar(1)*("+string(No_of_para_sci2blif)+"-1)+ss) == 6 then cap_size_string=""#cap_3x =0&cap_2x =0&cap_1x =0""; end",fd_w);
    ...
    if No_gnd_out ~= 0 then //<---
        for i=1:No_gnd_out
            mputl("        l1_str= """+strcat(string_gnd_out(i,1:3),' ')+"="+string_gnd_out(i,4)+"+"" "+string_gnd_out(i,5)+"="+string_gnd_out(i,6)+"+"" "+string_gnd_out(i,7)+"="+string_gnd_out(i,8)+"+"" "+string_gnd_out(i,9)+string_gnd_out(i,10)+" ="+string_gnd_out(i,12)+""";",fd_w);
            mputl("        mputl(l1_str,fd_w);",fd_w);
            mputl("        mputl(""  "",fd_w);",fd_w);
        end
    end
