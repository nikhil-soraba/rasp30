...
class cab_vmmStats(stats):
    ...
    # outputs order into the CAB
        li_sm_0b = ['fgota[0:1].out[0]','ota_buf[0].out[0]','ota[0].out[0]','cap[0:3].out[0]','nfet[0:1].out[0]','pfet[0:1].out[0]','tgate[0:3].out[0]','nmirror_vmm[0:1].out[0]','ladder_blk[0].out[0:1]','c4_blk[0].out[0]','hhneuron[0].out[0:2]','speech[0].out[0:1]','INFneuron[0].out[0]','lpf[0].out[0]','nfet_i2v[0].out[0]','pfet_i2v[0].out[0]','peak_detector[0].out[0]','ramp_fe[0].out[0]','sigma_delta_fe[0].out[0]','vmm_senseamp1[0].out[0]','vmm_senseamp2[0].out[0:1]','wta[0].out[0]','wta_primary[0].out[0:1]','common_source[0].out[0]','gnd_out[0].out[0]','vdd_out[0].out[0]','in2in_x1[0].out[0]','in2in_x6[0].out[0]','volt_div[0:1].out[0]','integrator[0].out[0]','integrator_nmirror[0].out[0]','tgate_so[0].out[0]','vmm4x4_SR[0].out[0]','vmm8x4_SR[0].out[0]','SR4[0].out[0:7]','vmm4x4_SR2[0].out[0]','vmm4x4[0].out[0:3]','sftreg[0].out[0]','DAC_sftreg[0].out[0]','sftreg2[0].out[0]','mmap_local_swc[0].out[0]','th_logic[0].out[0]','vmm8x4[0].out[0]','vmm8x4_in[0].out[0]','vmm12x1[0].out[0]','vmm12x1_wowta[0].out[0]','fg_io[0].out[0]','INV_cs[0].out[0]','dendrite_4x4[0].out[0:3]','ladder_filter[0].out[0:2]','bias_gen[0].out[0:1]','sftreg3[0].out[0]','inv_mcab[0].out[0]','Hyst_diff[0].out[0]','Max_detect[0].out[0]','Min_detect[0].out[0]']
        li_sm_1 = ['fgota[0:1].in[0:1]','ota_buf[0].in[0]','ota[0].in[0:1]','cap[0:3].in[0]','nfet[0:1].in[0:1]','pfet[0:1].in[0:1]','tgate[0:3].in[0:1]','nmirror_vmm[0:1].in[0]','ladder_blk[0].in[0:1]','c4_blk[0].in[0:1]','hhneuron[0].in[0:3]','speech[0].in[0:2]','INFneuron[0].in[0:2]','lpf[0].in[0]','nfet_i2v[0].in[0]','pfet_i2v[0].in[0]','peak_detector[0].in[0:1]','ramp_fe[0].in[0]','sigma_delta_fe[0].in[0:4]','vmm_senseamp1[0].in[0:1]','vmm_senseamp2[0].in[0:3]','wta[0].in[0:1]','wta_primary[0].in[0]','common_source[0].in[0]','gnd_out[0].in[0:1]','vdd_out[0].in[0:1]','in2in_x1[0].in[0:2]','in2in_x6[0].in[0:12]','volt_div[0:1].in[0:1]','integrator[0].in[0:2]','integrator_nmirror[0].in[0:2]','tgate_so[0].in[0:7]','vmm4x4_SR[0].in[0:6]','vmm8x4_SR[0].in[0:10]','SR4[0].in[0:3]','vmm4x4_SR2[0].in[0:7]','vmm4x4[0].in[0:3]','sftreg[0].in[0:18]','DAC_sftreg[0].in[0:2]','sftreg2[0].in[0:2]','mmap_local_swc[0].in[0:2]','th_logic[0].in[0:7]','vmm8x4[0].in[0:12]','vmm8x4_in[0].in[0:12]','vmm12x1[0].in[0:12]','vmm12x1_wowta[0].in[0:11]','fg_io[0].in[0]','INV_cs[0].in[0:1]','dendrite_4x4[0].in[0:3]','ladder_filter[0].in[0:1]','bias_gen[0].in[0]','sftreg3[0].in[0:3]','inv_mcab[0].in[0]','Hyst_diff[0].in[0]','Max_detect[0].in[0]','Min_detect[0].in[0]','cab_vmm.O[0:7]']
