...
class cab_vmmStats(stats):
    ...
    # outputs order into the CAB
        li_sm_0b = ['fgota[0:1].out[0]','ota_buf[0].out[0]','ota[0].out[0]','ota_vmm[0].out[0]','cap[0:3].out[0]','nfet[0:1].out[0]','pfet[0:1].out[0]','tgate[0:3].out[0]','nmirror_vmm[0:1].out[0]','ladder_blk[0].out[0:1]','c4_blk[0].out[0]','speech[0].out[0:1]','INFneuron[0].out[0]','lpf[0].out[0]','nfet_i2v[0].out[0]','pfet_i2v[0].out[0]','nmirror_w_bias[0].out[0]','fgswc_nmirror_w_bias[0].out[0]','i2v_pfet_gatefgota[0].out[0]','mismatch_meas[0].out[0]','peak_detector[0].out[0]','ramp_fe[0].out[0]','sigma_delta_fe[0].out[0]','vmm_senseamp1[0].out[0]','vmm_senseamp2[0].out[0:1]','wta[0].out[0]','wta_primary[0].out[0:1]','common_source[0].out[0]','gnd_out[0].out[0]','vdd_out[0].out[0]','in2in_x1[0].out[0]','in2in_x6[0].out[0]','volt_div[0].out[0]','volt_div_fgota[0].out[0]','integrator[0].out[0]','integrator_nmirror[0].out[0]','fgswitch[0].out[0]','tgate_so[0].out[0]','vmm4x4_SR[0].out[0]','vmm8x4_SR[0].out[0]','SR4[0].out[0:7]','vmm4x4_SR2[0].out[0]','vmm4x4[0].out[0:3]','sftreg[0].out[0]','DAC_sftreg[0].out[0]','sftreg2[0].out[0]','sftreg3[0].out[0]','sftreg4[0].out[0]','mmap_local_swc[0].out[0]','th_logic[0].out[0]','vmm8x4[0].out[0]','vmm8inx8in[0].out[0]','vmm8x4_in[0].out[0]','vmm12x1[0].out[0]','fg_io[0].out[0]','ladder_filter[0].out[0:2]','vmm12x1_wowta[0].out[0]','TIA_blk[0].out[0]','Adaptive_receptor[0].out[0]','inv_mcab[0].out[0]','Hyst_diff[0].out[0]','Max_detect[0].out[0]','Min_detect[0].out[0]']
        li_sm_1 = ['fgota[0:1].in[0:1]','ota_buf[0].in[0]','ota[0].in[0:1]','ota_vmm[0].in[0:1]','cap[0:3].in[0]','nfet[0:1].in[0:1]','pfet[0:1].in[0:1]','tgate[0:3].in[0:1]','nmirror_vmm[0:1].in[0]','ladder_blk[0].in[0:1]','c4_blk[0].in[0:1]','speech[0].in[0:2]','INFneuron[0].in[0:2]','lpf[0].in[0]','nfet_i2v[0].in[0]','pfet_i2v[0].in[0]','nmirror_w_bias[0].in[0:1]','fgswc_nmirror_w_bias[0].in[0]','i2v_pfet_gatefgota[0].in[0]','mismatch_meas[0].in[0:2]','peak_detector[0].in[0:1]','ramp_fe[0].in[0]','sigma_delta_fe[0].in[0:4]','vmm_senseamp1[0].in[0:1]','vmm_senseamp2[0].in[0:3]','wta[0].in[0:1]','wta_primary[0].in[0]','common_source[0].in[0]','gnd_out[0].in[0:1]','vdd_out[0].in[0:1]','in2in_x1[0].in[0:2]','in2in_x6[0].in[0:12]','volt_div[0].in[0:1]','volt_div_fgota[0].in[0:1]','integrator[0].in[0:2]','integrator_nmirror[0].in[0:2]','fgswitch[0].in[0]','tgate_so[0].in[0:7]','vmm4x4_SR[0].in[0:6]','vmm8x4_SR[0].in[0:10]','SR4[0].in[0:3]','vmm4x4_SR2[0].in[0:7]','vmm4x4[0].in[0:3]','sftreg[0].in[0:18]','DAC_sftreg[0].in[0:2]','sftreg2[0].in[0:2]','sftreg3[0].in[0:3]','sftreg4[0].in[0:3]','mmap_local_swc[0].in[0:2]','th_logic[0].in[0:7]','vmm8x4[0].in[0:12]','vmm8inx8in[0].in[0:16]','vmm8x4_in[0].in[0:12]','vmm12x1[0].in[0:12]','fg_io[0].in[0]','ladder_filter[0].in[0:1]','vmm12x1_wowta[0].in[0:11]','TIA_blk[0].in[0]','Adaptive_receptor[0].in[0:1]','inv_mcab[0].in[0]','Hyst_diff[0].in[0]','Max_detect[0].in[0]','Min_detect[0].in[0]','cab_vmm.O[0:7]']
	...
	self.dev_types =['fgota']*2 + ['ota_buf']*1 + ['ota']*1 + ['ota_vmm']*1 + ['cap']*4+ ['nfet']*2 + ['pfet']*2 + ['tgate']*4 + ['nmirror_vmm']*2+['ladder_blk']*1+ ['c4_blk']*1+ ['speech']*1+ ['INFneuron']*1+ ['lpf']*1+['nfet_i2v']*1+['pfet_i2v']*1+['nmirror_w_bias']*1+['fgswc_nmirror_w_bias']*1+['i2v_pfet_gatefgota']*1+['mismatch_meas']*1+['peak_detector']*1+['ramp_fe']*1+['sigma_delta_fe']*1+['vmm_senseamp1']*1+['vmm_senseamp2']*1+['wta']*1+['wta_primary']*1+['common_source']*1+['gnd_out']*1+['vdd_out']*1+['in2in_x1']*1+['in2in_x6']*1+['volt_div']*1+['volt_div_fgota']*1+['integrator']*1+['integrator_nmirror']*1+['fgswitch']*1+['tgate_so']*1+['vmm4x4_SR']*1+['vmm8x4_SR']*1+['SR4']*1+['vmm4x4_SR2']*1+['vmm4x4']*1+['sftreg']*1+['DAC_sftreg']*1 +['sftreg2']*1+['sftreg3']*1+['sftreg4']*1+['mmap_local_swc']*1+['th_logic']*1+['vmm8x4']*1+['vmm8inx8in']*1+['vmm8x4_in']*1+['vmm12x1']*1+['fg_io']*1+['ladder_filter']*1+['vmm12x1_wowta']*1+['TIA_blk']*1+['Adaptive_receptor']*1+['inv_mcab']*1+['Hyst_diff']*1+['Max_detect']*1+['Min_detect']*1
	self.dev_pins = {'fgota_in':2,'ota_buf_in':1,'ota_in':2,'ota_vmm_in':2, 'cap_in':1, 'nfet_in':2, 'pfet_in':2,'tgate_in':2,'nmirror_vmm_in':1,'ladder_blk_in':2, 'c4_blk_in':2,'speech_in':3,'INFneuron_in':3,'lpf_in':1,'nfet_i2v_in':1,'pfet_i2v_in':1,'nmirror_w_bias_in':2,'fgswc_nmirror_w_bias_in':1,'i2v_pfet_gatefgota_in':1,'mismatch_meas_in':3,'peak_detector_in':2,'ramp_fe_in':1,'sigma_delta_fe_in':5,'vmm_senseamp1_in':2,'vmm_senseamp2_in':4,'wta_in':2,'wta_primary_in':1,'common_source_in':1,'gnd_out_in':2,'vdd_out_in':2,'in2in_x1_in':3,'in2in_x6_in':13,'volt_div_in':2,'volt_div_fgota_in':2,'integrator_in':3,'integrator_nmirror_in':3,'fgswitch_in':1,'tgate_so_in':8,'vmm4x4_SR_in':7,'vmm8x4_SR_in':11,'SR4_in':4,'vmm4x4_SR2_in':8,'vmm4x4_in':4,'vmm12x1_in':13,'fg_io_in':1,'ladder_filter_in':2,'vmm12x1_wowta_in':12,'TIA_blk_in':1,'Adaptive_receptor_in':2,'inv_mcab_in':1,'Hyst_diff_in':1,'Max_detect_in':1,'Min_detect_in':1,'fgota_out':1,'ota_buf_out':1,'ota_out':1,'ota_vmm_out':1, 'cap_out':1, 'nfet_out':1, 'pfet_out':1,'tgate_out':1,'nmirror_vmm_out':1,'ladder_blk_out':2, 'c4_blk_out':1,'speech_out':2,'INFneuron_out':1,'lpf_out':1,'nfet_i2v_out':1,'pfet_i2v_out':1,'nmirror_w_bias_out':1,'fgswc_nmirror_w_bias_out':1,'i2v_pfet_gatefgota_out':1,'mismatch_meas_out':1,'peak_detector_out':1,'ramp_fe_out':1,'sigma_delta_fe_out':1,'vmm_senseamp1_out':1,'vmm_senseamp2_out':2,'wta_out':1,'wta_primary_out':2,'common_source_out':1,'gnd_out_out':1,'vdd_out_out':1,'in2in_x1_out':1,'in2in_x6_out':1,'volt_div_out':1,'volt_div_fgota_out':1,'integrator_out':1,'integrator_nmirror_out':1,'fgswitch_out':1,'tgate_so_out':1,'vmm4x4_SR_out':1,'vmm8x4_SR_out':1,'SR4_out':8,'vmm4x4_SR2_out':1,'vmm4x4_out':4, 'sftreg_in':19, 'DAC_sftreg_in':3, 'sftreg_out':1,'DAC_sftreg_out':1, 'sftreg2_in':3,'sftreg3_in':4,'sftreg4_in':4,'sftreg2_out':1,'sftreg3_out':1,'sftreg4_out':1,'mmap_local_swc_in':3, 'mmap_local_swc_out':1,'th_logic_in':8, 'th_logic_out':1,'vmm8x4_in':13,'vmm8x4_out':1,'vmm8inx8in_in':17,'vmm8inx8in_out':1,'vmm8x4_in_in':13,'vmm8x4_in_out':1,'vmm12x1_out':1,'fg_io_out':1,'ladder_filter_out':3,'vmm12x1_wowta_out':1,'TIA_blk_out':1,'Adaptive_receptor_out':1,'inv_mcab_out':1,'Hyst_diff_out':1,'Max_detect_out':1,'Min_detect_out':1}
	...
	print "getting here!"
	    ...
	    #print sb
		    ...
		    for s in range(len(ex_fg)):
				...
				if swc_name0 in["ladder_blk[0]","TIA_blk[0]","c4_blk[0]","speech[0]","INFneuron[0]","lpf[0]","peak_detector[0]","ramp_fe[0]",'sigma_delta_fe[0]','nmirror_vmm[0]',"Adaptive_receptor[0]"]:
					#pdb.set_trace()
					swc_name1 = j
				#elif 
				...
				for n in range(len(swc2)):
					...
					if ex_fg[s].split('=')[0] in ['ota_p_bias ','ota_n_bias ','fgota0nbias ','fgota0pbias ','fgota1nbias ','fgota1pbias ','i2v_pfet_gatefgota_fgotapbias[0]','i2v_pfet_gatefgota_fgotanbias[0]','mismatch_meas_pfetg_fgotapbias[0]','mismatch_meas_pfetg_fgotanbias[0]','mismatch_meas_out_fgotapbias[0]','mismatch_meas_out_fgotanbias[0]','vd_fgota_pbias[0]','vd_fgota_nbias[0]']:
						swcx.append(3)
					elif swc_name1 in ['c4_ota_p_bias[0]','c4_ota_n_bias[0]','TIA_ota_p_bias[0]','TIA_ota_n_bias[0]','TIA_ota_p_bias[1]','TIA_ota_n_bias[1]','c4_ota_p_bias[1]','c4_ota_n_bias[1]','peak_ota_n_bias[0]','peak_ota_p_bias[0]']:
						swcx.append(3)	
					elif swc_name1 in ['c4_ota_bias[0]','TIA_fgota_bias[0]','TIA_fgota_bias[1]','TIA_ota_bias[0]','TIA_ota_buf_out[0]','c4_ota_bias[1]','peak_ota_bias[0]','wta_bufbias[0]','wta_primary_bufbias[0]','speech_peakotabias[0]','speech_peakotabias[1]','vmm12x1_otabias[0]','nfet_i2v_otabias[0]','pfet_i2v_otabias[0]','i2v_pfet_gatefgota_ota0bias[0]','i2v_pfet_gatefgota_fgotabias[0]','mismatch_meas_pfetg_fgotabias[0]','mismatch_meas_out_fgotabias[0]','th_logic_otabias[0]']:
						swcx.append(2)
